...
| _UNINSTALL_TEMPLATE   | one value   | "\${CMAKE\_SOURCE\_DIR}/\ncmake/cmake\_uninstall.cmake.in"     | Available when `_IS_COMPONENT` is undefined, a template file for unload operations |
